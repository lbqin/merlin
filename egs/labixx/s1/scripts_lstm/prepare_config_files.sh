...
then
    ...
    echo "hidden_layer_type  : ['LSTM', 'LSTM', 'LSTM', 'LSTM', 'LSTM', 'LSTM']" >> $duration_config_file
fi

echo "#if RNN or sequential training is used, please set sequential_training to True." >> $duration_config_file
echo "sequential_training : True" >> $duration_config_file
...
echo "L1_regularization: 0.0"  >> $duration_config_file
echo "L2_regularization: 0.00001"  >> $duration_config_file
echo "private_l2_reg   : 0.00001" >> $duration_config_file
echo "hidden_activation: tanh" >> $duration_config_file
...
then
    ...
    echo "hidden_layer_type  : ['LSTM', 'LSTM', 'LSTM', 'LSTM', 'LSTM', 'LSTM']" >> $acoustic_config_file
fi

echo "#if RNN or sequential training is used, please set sequential_training to True." >> $acoustic_config_file
echo "sequential_training : True" >> $acoustic_config_file
...
echo "L1_regularization: 0.0"  >> $acoustic_config_file
echo "L2_regularization: 0.00001"  >> $acoustic_config_file
echo "private_l2_reg   : 0.00001" >> $acoustic_config_file
echo "hidden_activation: tanh" >> $acoustic_config_file
