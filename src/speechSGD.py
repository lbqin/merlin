"""
copy from mxnet speech demo
the reason to use this sgd is that, this sgd will update the momenton when get_lr_, and this what we want
"""
import mxnet as mx
...
class speechSGD(mx.optimizer.Optimizer):
    ...
    def update(self, index, weight, grad, state):
        ...
        #logging.info("learning rate %f , momontum: %f, wd: %f" % (lr, momentum, wd))
